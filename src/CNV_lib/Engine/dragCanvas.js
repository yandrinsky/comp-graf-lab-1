...
import mousePosition from "./eventsHandles/mousePosition";
...
function onMouseMove(e) {
    ...
    if(Store.state.draggableCanvas){
        ...
        preventRender(() => {
            Store.state.__shapes[Store.state.systemShapes['shiftIndicator'].system.getID()]?.updateText(`${Store.state.shift.x} ${Store.state.shift.y}`);
        })
